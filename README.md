...
# Cloud:
  ...
  Azure function is subscribed to 'ordersqueue', reads the message, send user order vonfirmed e-mail and then send it to other query 'productquantityupdatequeue'. 
